...
# NOTE: if considering an ensemble of seeds,
# input model name without the seed
...
if __name__ == "__main__":
    ...
    # change as needed to
    # desired ensemble of seeds
    # or no ensemble at all
    ...
    all_xx_correlations = np.array(all_xx_correlations).reshape((len(names), -1))
    averaged_zz_correlations = np.mean(all_zz_correlations[:, 5, :], axis=0)
